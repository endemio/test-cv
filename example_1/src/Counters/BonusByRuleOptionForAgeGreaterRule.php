...
class BonusByRuleOptionForAgeGreaterRule extends AbstractCountBonusByRuleOption
{
    ...
    public function count()
    {
        ...
        #print 'recountBonusForAgeGreaterRule for '.$this->employer->getName().PHP_EOL;

        $deltaAge = $this->employer->getAge() + 1;
        $indexAge = -1;
        ...
        foreach ($this->rules as $index => $rule) {
            ...
            if ($this->ifValueGreaterThen($this->employer->getAge(), $rule->getAge())) {
